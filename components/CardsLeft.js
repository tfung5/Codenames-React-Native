...
export default ({redLeft, blueLeft, canEnd}) => {
    const hidden = ((canEnd) => {
        ...
        return (
            <>
                <TouchableOpacity style={{backgroundColor: 'white', borderColor: 'red', borderRadius: 10, borderWidth: 2, alignItems: 'center', justifyContent: 'center', margin: 10, paddingHorizontal: 10, paddingVertical: 2}}>
